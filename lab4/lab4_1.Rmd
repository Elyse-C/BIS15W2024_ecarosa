...
```{r}
rename(mammal, genus="Genus", max.life="max. life", litters_per_year="litters/year", wean_mass="wean mass", litter_size="litter size")
```
...
```{r}
mass <- select(mammal, "Genus", "species", "mass")
```
