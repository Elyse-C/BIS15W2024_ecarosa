...
##    common_name                        n
##    <chr>                          <int>
##  1 Marine fishes nei              14289
##  2 Yellowfin tuna                  6866
##  3 Sharks, rays, skates, etc. nei  6405
##  4 Skipjack tuna                   5785
##  5 Bigeye tuna                     5341
##  6 Swordfish                       5143
##  7 Albacore                        4441
##  8 Mullets nei                     4141
##  9 Rays, stingrays, mantas nei     3706
## 10 Marine molluscs nei             3516
## # ℹ 1,541 more rows
```
...
```r
fisheries_tidy %>% 
  select(asfis_species_name, country, year) %>% 
...
## India, Spain, France, Algeria, and Cambodia

```r
fisheries_tidy %>% 
  select(common_name, country, year) %>% 
